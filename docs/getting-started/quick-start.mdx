...
Save the [Petstore OpenAPI schema](https://petstore.swagger.io/v2/swagger.json) as `./openapi.json` in your project directory. All examples below reference this file path.
