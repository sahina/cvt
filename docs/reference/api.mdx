...
| Method                    | Description                                              |
| ------------------------- | -------------------------------------------------------- |
| `ValidateInteraction`     | Validate an HTTP request/response pair against a schema  |
...
| `schema version not found`     | The requested schema version does not exist     |
| `consumer not found`           | The requested consumer is not registered        |
...
| gRPC Code          | Cause                                      |
| ------------------ | ------------------------------------------ |
| `UNAUTHENTICATED`  | Missing or invalid API key (if auth enabled) |
...
- **[CLI Reference](./cli.mdx)** - Command-line interface for CVT
